...
app.use(express.static(path.join(__dirname, '../', '/public'))).use('/', require('./server/routes/default')).use('/bower_components', express.static(path.join(__dirname, '../', '/bower_components')));
